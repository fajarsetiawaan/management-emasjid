...
// ─── 2D Accounting: Dimension 2 (Funds / Logical) ─
...
// ─── Transactions (Linked to Asset & Fund) ──────
...
export const MOCK_TRANSACTIONS: Transaction[] = [
    ...
    },
    {
        ...
        type: 'INCOME',
        accountId: 'asset_bca',
        fundId: 'kas_wakaf', // Corrected from kas_pembangunan to kas_wakaf as it exists in MOCK_FUNDS
        category: 'WAKAF',
